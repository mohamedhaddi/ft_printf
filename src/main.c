...
void	test_ft_printf(char type, char *mainstr, int n1 , unsigned int n2, char c, void *p, char *s)
{
	printf("Result:\n");
	if (type == 'd' || type == 'i')
...
void	test_printf(char type, char *mainstr, int n1 , unsigned int n2, char c, void *p, char *s)
{
	printf("Result:\n");
	if (type == 'd' || type == 'i')
		printf(mainstr, n1);
...
void check(char type, char *mainstr, int n1, unsigned int n2, char c, char *which_printf, void *p, char *s)
{
	printf("Test:\n%s", mainstr);
	if (type == 'd' || type == 'i')
		printf("With arg:\nint n = %d\n", n1);
...
int	main(int argc, char *argv[])
{
	...
	void *p[5] = {(void *)0x7fff5f14ca48, (void *)2147483647, (void *)0, (void *)4294967295, (void *)1};
	...
	if (argc == 3)
	{
		...
		while (j < n)
		{
			check(type[i], mystrcat("this is just a %", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %0", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-.", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.-", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %0-.", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			...
			check(type[i], mystrcat("this is just a %.0-", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.-0", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.-5", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.-1", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-.5", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-.1", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.5", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.1", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			...
			check(type[i], mystrcat("this is just a %5", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %1", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %05", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %01", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %050", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-050", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %0-50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.-50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.50-", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.050", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.-050", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %.0-50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %20.50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-20.50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %020.50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %20.-50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-20.-50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %020.-50", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %50.20", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-50.20", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %050.20", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %50.-20", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-50.-20", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %050.-20", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			check(type[i], mystrcat("this is just a %-0--00-30--300-0-...-50-3", type[i]), n1[j], n2[j], c[j], argv[2], p[j], s[j]);
			j++;
		}
	}
	return 0;
